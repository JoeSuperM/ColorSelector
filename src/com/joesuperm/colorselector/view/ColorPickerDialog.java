package com.joesuperm.colorselector.view;
...
public class ColorPickerDialog extends Dialog {
    ...
    private final String TAG = "openColorDialog";
    ...
    private class ColorPickerView extends View {
        ...
        private Paint mCenterTextPaint;// 中间圆文字画笔
        ...
        public ColorPickerView(Context context, int height, int width) {
            ...
            mCenterTextPaint.setStrokeWidth(5);
        ...
        private void drawTextCenter(Canvas canvas, Rect targetRect, Paint paint, String text) {
            FontMetricsInt fontMetrics = paint.getFontMetricsInt();
            int baseline = targetRect.top + (targetRect.bottom - targetRect.top - fontMetrics.bottom + fontMetrics.top)
                           / 2
                           - fontMetrics.top;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            // 画中心的字
            mCenterTextPaint.setColor(getReverseColor(mCenterPaint.getColor()));
            int distance = (int) Math.round((Math.sqrt(3) / 2.0F * centerRadius));
            Rect targetRect = new Rect(-distance, -distance, distance, distance);
            drawTextCenter(canvas, targetRect, mCenterTextPaint, "确定");
            // 是否显示中心圆外的小圆环
     ...
     * 回调接口
     * 
     * @author <a href="clarkamx@gmail.com">LynK</a> Create on 2012-1-6
     *         上午8:21:05
     */
